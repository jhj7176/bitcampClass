		...
		<tr>
			...
			<td colspan="6">
				<center>
					...
					<table>
						<tr align="center">
							<td bgcolor="fafad2" width = "100"><a href="edit.jsp?empno='<%=rs.getInt(1)%>'">수 정</a></td>
							<td bgcolor="fafad2" width = "100" ><a href="delete.jsp?empno='<%=rs.getInt(1)%>'">삭 제</a></td>
							<td bgcolor="fafad2" width = "100"><a href="list.jsp">돌아가기</a></td>
						</tr>
					</table>
